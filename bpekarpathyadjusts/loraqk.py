...
#         return x
# #this is horrible if put into final mlp layer
# class Lora(nn.Module):
#     def __init__(self, num_input, num_output, smallk):
#         super().__init__()
#         self.wa = nn.Linear(num_input, smallk)
#         self.wb = nn.Linear(smallk, num_output)
...
#         # self.lm_head = Lora(n_embed, vocab_size, smallk)  
