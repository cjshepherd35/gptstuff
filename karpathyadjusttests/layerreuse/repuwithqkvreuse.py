#ill have to relook at this, idk what my idea was here. 
import torch
...
sample = textraw['train'].select(range(10_000))
...
class RePU(nn.Module):
    ...
    def __init__(self, initial_a=0.5, initial_b=1.0, initial_c=0.5, initial_d=0.5):
