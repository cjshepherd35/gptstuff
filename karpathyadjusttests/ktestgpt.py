...
#the regular gpt made by karpathy video. 
#next experiment was to get rid of separation of key and values in self attention. they are 
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.nn = nn.Linear(n_embed, 4*n_embed)
        self.r = nn.ReLU(), 
        self.nn2 = nn.Linear(4*n_embed, n_embed)
        self.ln_f2 = nn.LayerNorm(n_embed)
        #####
